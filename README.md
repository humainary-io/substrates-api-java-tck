...
2. **The published Humainary artifacts are Maven-resolvable.** The defaults are:
   - `io.humainary.substrates:humainary-substrates-api:3.0.2` — the Substrates API
   - `io.humainary.specs:humainary-specs-api:3.0.2` — the `@SpecDoc` / `@SpecRef` traceability
...
This TCK defaults to `3.0.2` for every Humainary artifact it resolves. Intentional overrides can be
