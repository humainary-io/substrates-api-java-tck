...
/// Conformance tests for SPEC §§4.5 and 8.2–8.3 Slot behavior and tests for the Java projection's
/// enum, template, primitive, and reference-type conveniences.
/// @author William David Louth
/// @since 1.0
@SpecDoc("https://github.com/humainary-io/substrates-api-spec/blob/3.0.1/SPEC.md")
final class SlotContractTest
  extends TestSupport {

  private Cortex cortex;

  /// State#value(Slot) falls back to an enum-derived template value.
  @Test
  void enumSlot_absentFromState_returnsTemplateValue() {
  ...
  /// State#state(Enum) stores an enum-derived Name slot.
  @Test
  void enumSlot_addedToState_isRetrievableByTemplate() {
  ...
  /// Cortex#slot(Enum) derives the slot name from the enum type.
  @Test
  void enumSlot_createdFromEnum_derivesCanonicalName() {
  ...
  /// Cortex#slot(Enum) exposes its derived Name slot properties.
  @Test
  void enumSlot_createdFromEnum_exposesNameTypeAndValue() {
  ...
  /// Cortex#slot(Enum) uses the enum constant's canonical Name value.
  @Test
  void enumSlot_createdFromEnum_usesCanonicalNameAsValue() {
  ...
  /// Cortex#slot(Enum) represents the enum value with Name type.
  @Test
  void enumSlot_createdFromEnum_usesNameValueType() {
  ...
  /// Cortex#slot(Enum) maps equal constant names to canonical Name slots.
  @Test
  void enumSlot_differentEnumTypesWithSameConstant_shareNameType() {
  ...
  /// State#state(Enum) retains distinct enum-derived names.
  @Test
  void enumSlot_multipleValuesInState_areRetrievable() {
  ...
  /// Cortex#slot(Enum) rejects null per the API absence contract.
  @Test
  void enumSlot_nullEnum_throwsNullPointerException() {
  ...
  /// State#value(Slot) prefers a stored value over its enum template.
  @Test
  void enumSlot_presentInState_returnsStoredValue() {
  ...
  /// State#value(Slot) returns the template value when absent.
  @Test
  void slot_absentFromState_returnsTemplateValue() {
  ...
  /// A Boolean slot exposes its name, type, and immutable value.
  @SpecRef({"8.2", "8.3"})
  @Test
  void slot_boolean_exposesNameTypeAndValue() {
  ...
  /// A Double slot exposes its name, type, and immutable value.
  @SpecRef({"8.2", "8.3"})
  @Test
  void slot_double_exposesNameTypeAndValue() {
  ...
  /// A Float slot exposes its name, type, and immutable value.
  @SpecRef({"8.2", "8.3"})
  @Test
  void slot_float_exposesNameTypeAndValue() {
  ...
  /// An Integer slot exposes its name, type, and immutable value.
  @SpecRef({"8.2", "8.3"})
  @Test
  void slot_integer_exposesNameTypeAndValue() {
  ...
  /// A Long slot exposes its name, type, and immutable value.
  @SpecRef({"8.2", "8.3"})
  @Test
  void slot_long_exposesNameTypeAndValue() {
  ...
  /// A Name slot exposes its name, type, and immutable value.
  @SpecRef({"8.2", "8.3"})
  @Test
  void slot_name_exposesNameTypeAndValue() {
  ...
  /// Slot names retain canonical Name identity.
  @SpecRef({"4.1", "8.2"})
  @Test
  void slot_name_usesCanonicalNameIdentity() {
  ...
  /// Slot factories reject a null name per the API absence contract.
  @Test
  void slot_nullName_throwsNullPointerException() {
  ...
  /// Reference-valued slots reject absence.
  @SpecRef("15.2")
  @Test
  void slot_nullReferenceValue_throwsNullPointerException() {
  ...
  /// Primitive Slot factories expose the complete
  /// set of distinct required primitive Class classifiers.
  @SpecRef({"4.5", "8.3"})
  @Test
  void slot_primitiveFactories_exposeDistinctPrimitiveClassifiers() {
    ...
    final Set< Class< ? > > classifiers =
      Set.of(
        cortex.slot(boolName, true).type(),
        cortex.slot(intName, 0).type(),
        cortex.slot(longName, 0L).type(),
        cortex.slot(floatName, 0f).type(),
        cortex.slot(doubleName, 0.0).type()
      );

    assertEquals(
      Set.of(boolean.class, int.class, long.class, float.class, double.class),
      classifiers
    );

  }

  /// Reference Slot factories expose the complete
  /// set of distinct required reference Class classifiers.
  @SpecRef({"4.5", "8.3"})
  @Test
  void slot_referenceFactories_exposeDistinctReferenceClassifiers() {
    ...
    final Set< Class< ? > > classifiers =
      Set.of(
        cortex.slot(stringName, "").type(),
        cortex.slot(nameName, cortex.name("test")).type(),
        cortex.slot(stateName, cortex.state()).type()
      );

    assertEquals(Set.of(String.class, Name.class, State.class), classifiers);

  }

  /// State#value(Slot) supports every required reference slot type.
  @Test
  void slot_referenceTemplate_selectsMatchingNameAndType() {
  ...
  /// A slot value does not change across invocations.
  @SpecRef("8.2")
  @Test
  void slot_repeatedValueReads_returnUnchangedValue() {
  ...
  /// Independently created slots preserve their respective immutable values.
  @SpecRef("8.2")
  @Test
  void slot_sameNameAndTypeDifferentValues_areIndependent() {
  ...
  /// Slot lookup distinguishes equal names by value type.
  @SpecRef("8.2")
  @Test
  void slot_sameNameDifferentNumericTypes_selectsByType() {
  ...
  /// Slots with the same name and different types remain distinct.
  @SpecRef("8.2")
  @Test
  void slot_sameNameDifferentTypes_remainDistinct() {
  ...
  /// A State slot exposes its name, type, and immutable value.
  @SpecRef({"8.2", "8.3"})
  @Test
  void slot_state_exposesNameTypeAndValue() {
  ...
  /// A String slot exposes its name, type, and immutable value.
  @SpecRef({"8.2", "8.3"})
  @Test
  void slot_string_exposesNameTypeAndValue() {
  ...
  /// State#value(Slot) matches a stored slot by name and type.
  @Test
  void slot_usedAsStateTemplate_selectsMatchingNameAndType() {
